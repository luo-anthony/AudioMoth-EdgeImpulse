...
DEFINE_FUNCTION_ELSE(CP, 31, ISDIGIT, ADD_TO_BUFFER, IS('}'), CHECK_BUFFER_MIN_MAX_AND_SET(configSettings->recordDuration, MINIMUM_RECORD_DURATION, MAXIMUM_RECORD_DURATION, INC_STATE; CLEAR_BUFFER))
